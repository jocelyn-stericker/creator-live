...
void Options::define(const char* aDefinition) {
   ...
   int len = (int)strlen(aDefinition);
   ...
   int definitionIndex = (int)optionRegister.getSize();
...
void Options::define(const char* aDefinition, const char* ) {
   define(aDefinition);
...
void Options::appendOptions(int argc, char** argv) {
   ...
   int oldsize = (int)extraArgv.getSize();
   extraArgv.setSize(oldsize + argc);
   extraArgv_strings.setSize(oldsize + argc);
...
void Options::appendOptions(const char* strang) {
   ...
   int targc = (int) tempargv.getSize();
